...
public class MainPageActivity extends DefaultRequirementsCheckerCallback.Activity implements MediaPlayer.OnPreparedListener,
        ...
        try {
            switch (view.getId()) {
                ...
                case R.id.btnStartRaw:
                    ...
                    mediaPlayer = MediaPlayer.create(this, R.raw.edvard_munk);
                    mediaPlayer.start();
                    break;
